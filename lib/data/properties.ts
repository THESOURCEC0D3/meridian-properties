...
export const agents: Agent[] = [
  {
    ...
    bio: "Emeka has over 8 years of experience in Port Harcourt's luxury property market, specialising in GRA Phase 1, 2 and 3. He has facilitated over 150 successful transactions for oil executives, expatriates, and diaspora clients.",
  },
  {
    id: "agent-2",
    name: "Adaeze Nwosu",
    ...
    bio: "Ada specialises in mid-market residential sales and rentals across Woji, Eliozu, and Ada George. Known for her honest, transparent approach, she has helped over 200 families find their ideal homes in Port Harcourt.",
  },
  {
    id: "agent-3",
    name: "Tunde Fashola",
    role: "Commercial & Investment Consultant",
    phone: "08034567890",
    whatsapp: "2348034567890",
    photo: "/images/agents/agent-3.jpg",
    specialisation: "Trans-Amadi & Investment Properties",
    bio: "Tunde focuses on commercial properties and investment-grade residential assets across Trans-Amadi and Rumuola. He works primarily with corporate clients, property developers, and diaspora investors building portfolios.",
  },
];
